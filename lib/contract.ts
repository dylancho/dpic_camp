/**
 * ★★★ 원칙 에이전트 4개 사이의 계약서 (Interface Contract) ★★★
 *
 * 이 파일만 지키면 원칙별 구현을 서로의 코드를 안 보고 병렬로 개발할 수 있다.
...
export const PrincipleFindingsSchema = z.object({
  ...
  summary: z.string(),
  /**
   * 해당 원칙 스킬이 정의한 출력 형식(표·서사)을 그대로 채운 마크다운.
